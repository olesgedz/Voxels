...
public class Utils {
	...
	{
		float height = Map(0,maxHeight - 20, 0, 1, fBM(x*smooth*2,z*smooth*2,octaves+1,persistence));
		return (int) height;
	}
...
//     static float fBM (float x, float z, int oct, float pers) //fractal Brawnial  Motion
//     {
//             float total = 0;
//             float frequency = 1;
//             float amplitude = 1;
